    ...
    if(diary) {
        ...
        function showJournalContent(journal) {
            journal.forEach(day => {
                ...
                diaryBox.classList.add("content-box", "top-margin-16", "padding-8", "direction-column", "gap-0", "border-radius-64", "flex-wrap", "diary-box");
                ...
                diaryNote.innerHTML = `<md-ripple aria-hidden="true"></md-ripple><md-icon aria-hidden="true">notes</md-icon>`;
