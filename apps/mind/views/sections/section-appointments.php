<section id="section-appointments" class="align-center">
    <div class="simple-container direction-column width-100 gap-16 grow-1 ">
        ...
        <div class="simple-container flex-wrap gap-8" id="appts-stats-data-container">
            <div class="content-box gap-0 grow-1 basis-small user-select-none light-color hover-outline">
                <span class="label-normal outline-text">Citas agendadas</span>
                <span class="headline-small dm-sans on-background-text" name="total-appts">24 citas</span>
            </div>
            <div class="content-box gap-0 grow-1 basis-small user-select-none light-color hover-outline">
                <span class="label-normal outline-text">Citas canceladas</span>
                <span class="headline-small dm-sans on-background-text" name="total-cancelled-appts">6 citas</span>
            </div>
            <div onclick="togglePrettyWindow('#window-income', ['data-label', 'data-value'])" class="content-box gap-0 grow-1 basis-small user-select-none secondary-container on-secondary-containert-text hover-outline">
                <span class="label-normal" data-label>Ingresos estimados</span>
                <span class="headline-small dm-sans primary-text" name="total-income" data-value>$3,224.00</span>
            </div>
        </div>
        ...
        <div class="simple-container direction-column grow-1 gap-8 basis-large border-radius-16 max-height-100">
            ...
            <div class="simple-container direction-column gap-8">
                ...
                <div class="simple-container justify-center">
                    <md-filled-tonal-button id="load-more-appts">Cargar más</md-filled-tonal-button>
                </div>
            </div>
        </div>
